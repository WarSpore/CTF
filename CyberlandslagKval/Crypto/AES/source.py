...
shakespeare = open("CyberlandslagKval\Crypto\AES\shakespeare.txt","rb").read()[0:16*16]
...
#print(ciphertext)
for i in range(0,len(ciphertext),16):
    if i == 0:
        key = xor(ciphertext,shakespeare[i:i+16])
    if i == 16:
        key2 = xor(ciphertext[i:i+16],shakespeare[i:i+16])
    if i == 32:
        key3 = xor(ciphertext[i:i+16],shakespeare[i:i+16])
    if i == 48:
        key4 = xor(ciphertext[i:i+16],shakespeare[i:i+16])
    if i == 256:
        print(xor(ciphertext[i:i+16],key).decode("utf-8"),end="")
    if i == 272:
        print(xor(ciphertext[i:i+16],key2).decode("utf-8"),end="")
    if i == 288:
        print(xor(ciphertext[i:i+16],key3).decode("utf-8"),end="")
    if i == 304:
        print(xor(ciphertext[i:i+16],key4).decode("utf-8"),end="")
    #print(xor(ciphertext,shakespeare[i:i+16]))
